...
//
//                        ArrayList<MyPaymentsInvoiceProductModel> myPaymentsInvoiceProductModels = new ArrayList<>();
...
//                            String name = myordersModalData.getString("name");
                            myPaymentsInvoiceProductModels.add(new MyPaymentsInvoiceProductModel(id,user_id,product_id,quantity,amount,order_id,status,is_paid,invoice_id,tracking_status,tracking_id,partner_name,logged_date,created_by,updated_by,updated_date,invoicenum,product_name,attachment));
                        }
//                        handleResponse(myPaymentsInvoiceProductModels);
