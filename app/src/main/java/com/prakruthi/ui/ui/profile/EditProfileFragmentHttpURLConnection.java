 ...
 */
//public class EditProfileFragmentHttpURLConnection extends Fragment {
...
//public class EditProfileFragmentHttpURLConnection extends Fragment implements UserDetailsUpdateApi.OnUserDetailsUpdateApiGivesFetchedListner{
...
//        binding = FragmentEditProfileHttpURLConnectionBinding.inflate(inflater, container, false);
...
//                    new ApiTask1().execute(Variables.userId, Variables.token,fullnameStr, emailStr, cityStr, stateStr, districtStr);
                    new ApiTask1Http().execute(userId, token, fullnameStr, emailStr, cityStr, stateStr, districtStr);
//                    new ApiTask1Http().execute(String.valueOf(Variables.id), Variables.token, fullnameStr, emailStr, cityStr, stateStr, districtStr);
...
//            Variables.id = String.valueOf(Integer.valueOf(id));
//            Variables.departmentId = String.valueOf(Integer.valueOf(departmentId));
...
//            UserDetailsUpdateApi userDetailsUpdateApi = new UserDetailsUpdateApi(EditProfileFragmentHttpURLConnection.this, Variables.userId, Variables.token, name, email, city, Variables.state, Variables.district);
//            UserDetailsUpdateApi userDetailsUpdateApi = new UserDetailsUpdateApi(EditProfileFragmentHttpURLConnection.this, Variables.userId, Variables.token, name, email, city, state, district);
//            UserDetailsUpdateApi userDetailsUpdateApi = new UserDetailsUpdateApi(EditProfileFragmentHttpURLConnection.this, userId, token, name, email, city, state, district);
