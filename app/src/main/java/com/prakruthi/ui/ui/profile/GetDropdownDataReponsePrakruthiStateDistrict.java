...
//    ArrayList<GetDropdownDataReponsePrakruthi.GetDropdownDataReponsePrakruthiState> getDropdownDataReponsePrakruthiState;
...
//    public GetDropdownDataReponsePrakruthiStateDistrict(ArrayList<State> state, ArrayList<District> district) {
//        this.state = state;
